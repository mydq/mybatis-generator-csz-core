...
public class MyJavaTypeResolverDefaultImpl implements JavaTypeResolver {
	...
	public MyJavaTypeResolverDefaultImpl() {
		...
		typeMap.put(Types.JAVA_OBJECT, new JdbcTypeInformation("JAVA_OBJECT", //$NON-NLS-1$
				new FullyQualifiedJavaType(Object.class.getName())));
		typeMap.put(Jdbc4Types.LONGNVARCHAR, new JdbcTypeInformation(
	...
	public FullyQualifiedJavaType calculateJavaType(
		...
		System.out.println(introspectedColumn.getActualColumnName() + "---" + introspectedColumn.getJdbcType());
